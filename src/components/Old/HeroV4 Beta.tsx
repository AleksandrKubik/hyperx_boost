...
import { XIcon, TelegramIcon, YoutubeIcon } from './icons/SocialIcons';
...
export default function HeroV4() {
    ...
    return (
        <section className="relative min-h-[calc(100vh-64px)] flex items-center py-20 overflow-hidden">
                    ...
                    {socialServices.map((service, index) => (
                        <div
                            ...
                            className={`group relative flex flex-col items-center gap-12 p-8 rounded-2xl
                                ...
                                ${index === 1 ? 'translate-y-16' : '-translate-y-8'}
                                transform
                                ${showCards ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}
                                ${index === 1 ?
                                    (showCards ? 'translate-y-16' : 'translate-y-36') :
                                    (showCards ? '-translate-y-8' : 'translate-y-12')}`}
                            style={{
                        ...
                        >
                            <div
                                ...
                                style={{
                                    transitionDelay: isTransitioning ? '0ms' : `${socialServices.indexOf(service) * 100}ms`,
                            ...
                            <div
                                ...
                                style={{ transitionDelay: `${socialServices.indexOf(service) * 100}ms` }}
                            >
                                <Button
                                    variant="default"
